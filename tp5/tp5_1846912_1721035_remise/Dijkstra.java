...
public class Dijkstra {
	...
	public Edge identify(int i, Edge meilChemin) {
	...
	private void ajoutPath(Edge e, Node versN, int i, Node s) {
		do {
	...
	private void ajoutNodeTable(int i) {
	...
	public void findPath (Node s, Node d) {
		...
		while(estArriver == false) {
			...
			if(identify(i, meilChemin).getDestination()==d){estArriver =true;}
